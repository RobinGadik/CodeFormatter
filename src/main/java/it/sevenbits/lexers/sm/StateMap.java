...
class StateMap {
    ...
    StateMap() {
        ...
        states.put(new Pair<>(multilineCommentEnd, "QUOTE"), stringLiteral);
        states.put(new Pair<>(multilineCommentEnd, "OPEN_BLOCK"), openBlock);
        states.put(new Pair<>(multilineCommentEnd, "END_BLOCK"), endBlock);
        states.put(new Pair<>(multilineCommentEnd, "SPACE"), spaceUno);
        states.put(new Pair<>(multilineCommentEnd, "SLASH"), slash);
